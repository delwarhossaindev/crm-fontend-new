...
import win_probabilities from "@/stores/setting/win_probabilities_api.js";
...
function validateForm() {
  ...
  if (!form.value.name) errors.name = "winProbabilities Name is required";
...
const submitForm = async () => {
  if (validateForm()) {
    loading.value = true;
    try {
      const response = await win_probabilities.insertwinProbabilities(form.value);
